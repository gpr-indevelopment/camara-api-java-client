...
public class DeputadoClient extends Client {
    ...
    public Optional<Deputado> consultarDeputadoPorId(int id) throws IOException {
    ...
    public Pagina<Deputado> consultar(ConsultaDeputado consulta) throws IOException {
